        ...
        <div className="relative mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:py-20">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-700">
              Kirtan, Bhagavad-gita discussion, and a free vegetarian dinner - every{" "}
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[1.75rem] border border-amber-200/80 bg-white/90 shadow-xl shadow-amber-900/10 ring-1 ring-amber-100">
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-emerald-950/90 via-emerald-950/40 to-transparent p-6 pt-24">
                ...
                <p className="mt-1 text-sm text-emerald-100/90">Mantra - wisdom - community - prasadam</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {status === "ready" && upcoming.length > 0 ? (
          <section>
            ...
            <p className="mt-6 text-center">
              <Link to="/events" className="text-sm font-semibold text-emerald-900 underline hover:no-underline">
                {upcoming.length > 3 ? `View all ${upcoming.length} upcoming events` : "Open the Events page"}
              </Link>
            </p>
          </section>
        ) : null}
          ...
          <div>
            ...
            <ul className="mt-8 space-y-3 text-slate-700">
              <li className="flex gap-3">
                ...
                <span>Ask about the Bhagavad-gita, meditation, or vegetarian food.</span>
              </li>
              <li className="flex gap-3">
                <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-amber-500" />
        ...
        <section className="rounded-3xl border border-amber-200/70 bg-gradient-to-br from-white via-amber-50/80 to-emerald-50/40 p-6 shadow-sm ring-1 ring-amber-100 sm:p-10">
          <div className="grid gap-8 lg:grid-cols-[1fr_1.2fr] lg:items-center">
            <div>
              <SectionHeading
                eyebrow="Still"
                title="Kirtan - discussion - lineages"
            ...
            {posts.map((post) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-6">
                  ...
                  <Link to={`/posts/${post.slug}`} className="mt-4 text-sm font-semibold text-emerald-900 hover:underline">
                    Read article
                  </Link>
                </div>
              </article>
